...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Sashank Agarwal.</h2>;
  const three = <h3 className="big-heading">I unleash the cloud's potential.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      ...
      href="mailto:sashankagarwal97@gmail.com"
      target="_blank"
      rel="noreferrer">
      Contact Me!
    </a>
